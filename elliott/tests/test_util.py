...
class TestUtil(unittest.TestCase):
    ...
    def test_suffix_replacement(self):
        ...
        result = util.fix_summary_suffix("Some bug summary [old-stuff]", "[openshift-4.18]")
    ...
    def test_suffix_no_change_needed(self):
        ...
        result = util.fix_summary_suffix("Bug is fine [openshift-4.18]", "[openshift-4.18]")
        self.assertEqual(result, "Bug is fine [openshift-4.18]")

    def test_suffix_append(self):
        # Already ends with the correct suffix
        result = util.fix_summary_suffix("Append here", "[openshift-4.18]")
